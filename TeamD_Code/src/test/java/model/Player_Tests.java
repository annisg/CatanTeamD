...
public class Player_Tests {
    ...
    public void testFindDevelopmentCardFoundButNotPlayable() {
        ...
        ArrayList<DevelopmentCard> cards = new ArrayList<DevelopmentCard>(Arrays.asList(correctCard, new VictoryPointCard(messages)));
        EasyMock.expect(testPlayer.getDevelopmentCards()).andReturn(cards);
        EasyMock.replay(testPlayer);
    ...
    public void testFindDevelopmentCardFoundLast() {
        ...
        MonopolyCard correctCard = new MonopolyCard(messages);
        correctCard.makePlayable();
        ArrayList<DevelopmentCard> cards = new ArrayList<DevelopmentCard>(Arrays.asList(new VictoryPointCard(messages), correctCard));
        EasyMock.expect(testPlayer.getDevelopmentCards()).andReturn(cards);
        EasyMock.replay(testPlayer);
    ...
    public void testFindDevelopmentCardMultiple() {
        ...
        MonopolyCard correctCard = new MonopolyCard(messages);
        correctCard.makePlayable();
        ArrayList<DevelopmentCard> cards = new ArrayList<DevelopmentCard>(Arrays.asList(correctCard, new MonopolyCard(messages)));
        EasyMock.expect(testPlayer.getDevelopmentCards()).andReturn(cards);
        EasyMock.replay(testPlayer);
